...
\section{Project definition}
    ...
    Since the necessity of a solid code base from which extend the application, I've chosen to use some common libraries, both from the standard NodeJS ones and from NPM modules.
